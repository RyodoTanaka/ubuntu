...
RUN apt-get update -q && \
    apt-get upgrade -yq && \
    apt-get install -yq wget curl unzip git git-lfs build-essential vim emacs vlc gimp inkscape terminator net-tools arp-scan gcc g++ cmake python3-pip sudo lsb-release locales bash-completion tzdata gosu && \
